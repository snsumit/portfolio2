...
<p className="text-white text-[18px] font-bold cursor-pointer flex">Sumit &nbsp;
 <span className='sm:block hidden'>| FullStack Devloper
 </span>
 </p>
        ...
        <div 
         ...
         <ul className='list-none flex  justify-end  items-start flex-col gap-4 '>
           ...
           className={`${
            active === Link.title ?" text-white ":"text-secondary"
           } hover:text-white text-[15px] font-poppins font-medium cursor-pointer`}
           onClick={()=> {
            setToggle(!toggle)
