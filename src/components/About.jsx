   ...
   className='w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card'
    >
      ...
      >
       ...
       className='w-16 h-16 object-contains'
       />
...
const About = () => {
  return (
    ...
    <motion.div variants={textVariant()}>
      ...
      >
        I'm a skilled software devloper with
        Experience in TypeScript and 
        JavaScript, and Expertise in frameworks
        like, React Node.js and three.js. I'm a quick
        learner and callobrate closely with clients 
